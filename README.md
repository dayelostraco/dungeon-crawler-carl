...
├── tests/                # Unit + integration tests (209 tests)
...
- **Rarity tiers** — Bronze/Silver/Gold/Legendary with colored borders, card accents, audio treatment, and animated reveals (glow + sparkles for Gold/Legendary)
